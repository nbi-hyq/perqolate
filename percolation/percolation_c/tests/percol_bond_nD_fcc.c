...
int main(){
  ...
  // 3D fcc bond percolation (no simple cubic edges)
  Graph g = get_nd_simple_cubic_modified(50, 3, false, false, false, false, 2, 2, false, false, true);
  float sweep_prob[SWEEP_LEN] = {0.10, 0.14};
  int64_t idxLambda;
